    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header align-items-center d-flex justify-content-between">
                ...
                <a href="/transacciones/agregar" class="btn btn-light ml-auto">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($transacciones as $i)
                        <tr>
                            <td>{{ $i->id }}</td>
                            <td>{{ $i->concepto }}</td>
                            <td>{{ $i->monto }}</td>
                            <td>{{ $i->fecha }}</td>
                            <td>{{ $i->tipo_transaccion }}</td>
                            <td>{{ $i->cuenta_bancaria->num_cuenta }}</td>
                            <td style="width: 220px;">
                                <div class="btn-group align-items-center">
                                    <a href="/transacciones/{{ $i->id }}/detalles" class="btn btn-link">Detalles</a>
